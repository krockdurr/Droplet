...
#   from droplet_pkg.ui.windows.manual_recal import ManualRecalWindow, PeakReviewWindow
# without knowing where the class actually lives.


def ManualRecalWindow(*args, **kwargs):
    from droplet_pkg.app import ManualRecalWindow as _cls
    return _cls(*args, **kwargs)


def PeakReviewWindow(*args, **kwargs):
    from droplet_pkg.app import PeakReviewWindow as _cls
    return _cls(*args, **kwargs)
